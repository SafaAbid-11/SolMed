...
if(isset($_POST['register'] )) 
{
	...
	$mql = "insert into patient_table(patient_email_address,patient_password,patient_first_name,patient_last_name) VALUES('".$_POST['email']."','".$_POST['password']."','".$_POST['fname']."','".$_POST['lname']."')";
